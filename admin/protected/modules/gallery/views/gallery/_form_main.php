...
$this->widget('application.components.formElems',
    array(
        ...
        'model' => $model,
        'elems' => array(
            array('type' => FormElems::ELEM_TYPE_TEXT, 'attribute' => 'name', 'req' => 1, 'placeholder' => 'Введите название'),
            ...
            array('type' => FormElems::ELEM_TYPE_TEXTEDIT, 'attribute' => 'summary', 'placeholder' => 'Описание'),
            array('type' => FormElems::ELEM_TYPE_TEXTEDIT, 'attribute' => 'content', 'placeholder' => 'Содержание'),
...
$this->widget('application.components.formElems',
    array(
        ...
        'model' => $model->metatag,
        'elems' => array(
            array('type' => FormElems::ELEM_TYPE_TEXT, 'attribute' => 'alias', 'placeholder' => 'Псевдоним (Alias)'),
        )
    )
);
