...
class CActiveForm extends CWidget
{
	...
	{
		return CHtml::activeImageField($model,$attribute,$htmlOptions);
	}
    ...
    public function multiDropDownList($model,$attribute,$data,$dataselect,$htmlOptions=array())
	{
		return CHtml::activeMultiDropDownList($model,$attribute,$data,$dataselect,$htmlOptions);
	}
