...
$(".tomorrow_button").removeClass("tomorrow_button_active");
	...
	$('.map_contact_icons').find('ul').find('li').find('img').hover(function(){
		...
		var path;
		switch(src){
			case 'h_facebook': path='img/h_facebook.png' ; break;
			case 'h_twitter': path='img/h_twitter.png' ; break;
			case 'h_vk': path='img/h_vk.png' ; break;
			case 'h_inst': path='img/h_inst.png' ; break;
			case 'h_gmail': path='img/h_gmail.png' ; break;
			case 'h_ri': path='img/h_rist.png' ; break;
		...
		var path;
		switch(src){
			case 'h_facebook': path='img/map_facebook.png' ; break;
			case 'h_twitter': path='img/contact_twitter.png' ; break;
			case 'h_vk': path='img/contact_vk.png' ; break;
			case 'h_inst': path='img/contact_inst.png' ; break;
			case 'h_gmail': path='img/contact_gmail.png' ; break;
			case 'h_ri': path='img/contact_ri.png' ; break;
	...
	$('.upper_social_icons>p').hover(function(){
		...
		switch (icon_type ){
			case 'facebook': $(this).css('background-image', 'url(img/h_upper_facebook.png)'); break;
			case 'twitter': $(this).css('background-image', 'url(img/h_upper_twitter.png) '); break;
			case 'vk': $(this).css('background-image', 'url(img/h_upper_vk.png)'); break;
		}
		...
		switch (icon_type ){
			case 'facebook': $(this).css('background-image', 'url(img/upper_facebook.png) '); break;
			case 'twitter': $(this).css('background-image', 'url(img/upper_twitter.png) '); break;
			case 'vk': $(this).css('background-image', 'url(img/upper_vk.png) '); break;
