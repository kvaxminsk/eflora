...
<div class="wrap wrap_header">
    ...
    <div class="content header">
        ...
        <div class="basket"><img src="/images/basket.png"/>
            <snan class="baskettext">Корзина пуста</snan>
        </div>
    </div>
</div>
...
<div class="fon"></div>
<form name="shopPost" method="post"
      action="<? $this->widget('MaterialUrl', array('module' => 'shop', 'action' => 'index')) ?>">
    <div class="ordering ">
        <div class="formShop">
