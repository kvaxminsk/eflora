...
<!--		--><?//var_dump((int)($product->price * $kurs / 1000));die();?>
		...
		<div class="cart1_item_old_price old_price">
			<span> BR </span> <?= (int)($product->price * $kurs / 1000) ?> <sup><?=  round (($product->price * $kurs / 1000 -  ((int)($product->price * $kurs / 1000)) ) *1000) ?></sup>
			<hr>
		</div>

		<div class="cart1_item_new_price new_price">
			<span> BR </span> <?= (int)($product->price * $kurs / 10000) ?><sup><?= round (($product->price * $kurs / 10000 -  ((int)($product->price * $kurs / 10000)) ) *100) ?> коп</sup>
		</div>
