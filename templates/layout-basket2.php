            ...
            <ul class="list">
                ...
                <li id="second_column">
                    <div class="second_column_number">
                        ...
                        <div class="description">
                            <p id="second_description">Заказы по телефону без выходных 9:00–19:00 Заказы «день в день»
                                принимаем до 19:00
                        </div>
                    </div>
                </li>
            ...
            <div class="tab1">
                ...
                <ul class="cart1_item">
                    <li>
                        <img src="/images/eflora/cart1_pic1.png" alt="">
										<span class="niceCheck"><input type="checkbox" name="cart1_checkbox"
                                                                       class="cart1_checkbox"/>
										</span>
                ...
                <div class="cart1_contact_block">
                    <div class="cart1_left_contact_block">
                        ...
                        <input type="text" name="telephone" class="cart1_phone_input"
