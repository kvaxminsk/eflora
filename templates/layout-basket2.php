			...
			<ul class="list">
				<li id="first_column">
					...
					<div class= "phone_number">
						<div class="phone">
							<p class="first_phone">
								<!-- <span class="code">375 29</span> --><sup>375 29</sup> 335-43-43
							<div id="triangle"></div>
							</p>
						</div>
						<div class="description">
							<p id ="first_description">Белорусская служба 		доставки цветов   </p>
						</div>
					...
					<div class="second_column_number">
						<div class="phone1">
							<p class="second_phone">
								<sup>375 29</sup> 335-43-43
							</p>
						</div>
						<div class="description">
							<p id ="second_description">Заказы по телефону без выходных 9:00–19:00 Заказы «день в день»   принимаем до 	19:00
						</div>
					</div>
				</li>
				<li id="third_column">
					<div class="third_column_number">
						<div class="phone1">
							<p class="third_phone">
								<sup>375 17</sup> 262-22-96
							</p>
						</div>
						<div class="description">
							<p id ="third_description">Доставка принятых заказов с 9 до 21 без выходных  </p>
						</div>
					</div>
				</li>
			</ul>
			<div id= "backet_wrap">
				...
				<div id = "header_backet">
					<a href="#"   ><img class ="backet_pic"  src="/images/eflora/header_backet.png" alt="menu" />
						<div class="backet_circle"> <p>2</p></div>
					</a>
				</div>
	...
	<div class="main_content">
		<div class="crt_left_main_content">
				...
				<li>
					...
					<div class="order_list_count_wrapper">
						<div class="order_list_count_symbols">
							<div class="order_count_increment"></div>
							<input type="text" class="order_count"		name="order_count" maxlength="3" value="4">
							<div class="order_count_decrement">
							</div>
						</div>
			...
			<div class="order_list_help_address">
				<p>
					...
					Ввиду цветочных традиций международные флористы с целью обеспечения доставки в назначенный день могут заменить заказанные цветы на свежие цветы, которые есть в наличии. Это считается нормой.<br><br>

					В случае если Вы не указываете своего имени в поле Сообщение, получатель не сможет узнать, кто дарит цветы.
		...
		<div class="crt_right_main_content">
			...
			<div class="tab1">
				...
				<ul class="cart1_item">
					<li>
						<img src="/images/eflora/cart1_pic1.png" alt="">
										<span class="niceCheck"><input type="checkbox" name="cart1_checkbox"  class="cart1_checkbox" />
										</span>
					...
					<li><img src="/images/eflora/cart1_pic2.png" alt="">
						<span class="niceCheck"><input type="checkbox" name="cart1_checkbox"  class="cart1_checkbox" /></span>
					...
					<li><img src="/images/eflora/cart1_pic3.png" alt="">
						<span class="niceCheck"><input type="checkbox" name="cart1_checkbox"  class="cart1_checkbox" /></span>
					...
					<li><img src="/images/eflora/cart1_pic4.png" alt="">
						<span class="niceCheck"><input type="checkbox" name="cart1_checkbox"  class="cart1_checkbox" /></span>
				...
				<div class="cart1_note_block">
					...
					<textarea class="text_postcard" name="text_postcard" id="text_postcard" cols="30" rows="3" placeholder="Текст открытки и ваш комментарий к заказу"></textarea>
