...
<li>
    ...
    <div class="order_list_describe">
        ...
        <p class="order_list_price_old old_price"> <sub> BR </sub> <?= (int)($product->price * $kurs / 1000) ?> <sup><?=  round (($product->price * $kurs / 1000 -  ((int)($product->price * $kurs / 1000))) *1000) ?></sup>
        </p>
        <hr>
        <p class="order_list_price_new new_price"> <sub> BR </sub> <?= (int)($product->price * $kurs / 10000) ?> <sup><?= round (($product->price * $kurs / 10000 -  ( (int)($product->price * $kurs / 10000))) *100 ) ?>  коп.</sup>
        </p>
    ...
    <div class="order_list_count_wrapper">
        <div class="order_list_count_symbols">
            <div class="order_count_increment addtobasket"  data-productid="<?=$product->id?>" data-productprice="<?=$product->price?>"></div>
