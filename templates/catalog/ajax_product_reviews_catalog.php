...
<li class = "product">
    <div class="product_wrap">
        <div class="flower">
            ...
            <?}?>
            <a href="<?= $product->url?>"><img class ="flower_pic"  src="<?= $product->img['medium']?>" alt="<?= $product->name ?>" /></a>
        </div>
        <div class="old_price">
        ...
        <div class="in_cart_wrap" >
            <a href="" class="in_cart addtobasket addtocart" data-productid="<?=$product->id?>" data-productprice="<?=$product->price?>">
                <p> В КОРЗИНУ </p></a>
        </div>
