...
<li class = "product">
	<div class="product_wrap">
		...
		<div class="old_price">
			...
			<div class = "line"></div>
			<span class="zero_old_price"> <?=  round (($data->price * $kurs / 1000 -  ((int)($data->price * $kurs / 1000)) ) *1000) ?></span>
		</div>
		<div class="new_price">
			<span class="um">BR </span>
			<?= (int)($data->price * $kurs / 1000) ?>
			<span class="zero_old_price"><?= round (($data->price * $kurs / 1000 -  ((int)($data->price * $kurs / 1000)) ) *10) ?> коп</span>
		</div>
