                            ...
                            <div class="product-image-container">
                                <a class="product_img_link" href="<?= $alb['url']; ?>" title="<?= $alb->name; ?>">
                                    <img class="replace-2x img-responsive"
                                         src="<?= image($alb->img['path'], 'resize', '230', '230'); ?>"
                                         alt="<?= $alb->name; ?>" title="<?= $alb->name; ?>"/>
                                </a>
                            </div>
                        </div>
                    <? endif; ?>
            ...
            <li class="ajax_block_product col-xs-12 col-sm-6 col-md-4 first-item-of-tablet-line first-item-of-mobile-line"
                ...
                <div class="product-container">
                    <? if (!empty($img->image['path'])): ?>
                        <div class="left-block">
                            <div class="product-image-container">
                                <a class="product_img_link lightbox-image" data-gal="prettyPhoto[gallery]"
                                   href="<?= $img->image['path']; ?>" title="<?= $img->name; ?>">
                                    <img class="replace-2x img-responsive"
                                         src="<?= image($img->image['path'], 'resize', '230', '230'); ?>"
                    ...
                    <div class="right-block">
                        <h5 style="text-align: center;">
                            <a class="product-name lightbox-image" data-gal="prettyPhoto[gallery2]"
                               href="<?= $img->image['path']; ?>" title="<?= $img->name; ?>">
