$(document).ready(function(){
	...
	switch(true)
	{
		case window_width <= 1000 : window_type = "mobile"; 
		break;
		case window_width <= 1280: window_type = "tablet"; 
		break;
		default: window_type = "desctop" ;
	}
...
if ( window_type == 'tablet' || window_type== "mobile"){
	...
	$('#sandwich').click(function showToogle(){
		...
		switch(window_type){
			case 'desctop' :		helpmenuShow(0); 
			instheightMenu = installHeight($('.hidden_menu'));
			break;
			case 'tablet' : helpmenuShow(0); 
			instheightMenu = installHeight($('.hidden_menu'));
			break;
			case 'mobile' : helpmenuShow(0); 
			instheightMenu=installHeight($('.hidden_menu')); 
			break;
		}
	});
	...
	$("#question_icon").click(function(){
		...
		switch(window_type){
			case 'desctop' : instheightQuestion = installHeight($('.question_panel'));
			questionmenuShow(0);
			break;
			case 'tablet' :
	...
	$('.menu_panel_close').click(function(){
		switch(window_type){
			case 'tablet' : helpmenuShow(-365); break;
			case 'mobile' : helpmenuShow(-160); break;
		}
	})

	$('.help_panel_close').click(function(){
		switch(window_type){
			case 'tablet' : questionmenuShow(-365); break;
			case 'mobile' : questionmenuShow(-160); break;
		}
	})
...
$(".tomorrow_button").removeClass("tomorrow_button_active");
	...
	$('.map_contact_icons').find('ul').find('li').find('img').hover(function(){
		...
		var path;
		switch(src){
			case 'h_facebook': path='images/h_facebook.png' ; break;
			case 'h_twitter': path='images/h_twitter.png' ; break;
			case 'h_vk': path='images/h_vk.png' ; break;
			case 'h_inst': path='images/h_inst.png' ; break;
			case 'h_gmail': path='images/h_gmail.png' ; break;
			case 'h_ri': path='images/h_rist.png' ; break;
		...
		var path;
		switch(src){
			case 'h_facebook': path='images/map_facebook.png' ; break;
			case 'h_twitter': path='images/contact_twitter.png' ; break;
			case 'h_vk': path='images/contact_vk.png' ; break;
			case 'h_inst': path='images/contact_inst.png' ; break;
			case 'h_gmail': path='images/contact_gmail.png' ; break;
			case 'h_ri': path='images/contact_ri.png' ; break;
	...
	$('.upper_social_icons>p').hover(function(){
		...
		switch (icon_type ){
			case 'facebook': $(this).css('background-image', 'url(images/h_upper_facebook.png)'); break;
			case 'twitter': $(this).css('background-image', 'url(images/h_upper_twitter.png) '); break;
			case 'vk': $(this).css('background-image', 'url(images/h_upper_vk.png)'); break;
		}
		...
		switch (icon_type ){
			case 'facebook': $(this).css('background-image', 'url(images/upper_facebook.png) '); break;
			case 'twitter': $(this).css('background-image', 'url(images/upper_twitter.png) '); break;
			case 'vk': $(this).css('background-image', 'url(images/upper_vk.png) '); break;
